...
function M.assign(jobs, miner)
  ...
  if chosen then chosen.state="ASSIGNED"; chosen.assignedComputerId=miner.computerId; chosen.assignmentId="assignment-"..chosen.id.."-"..util.now(); chosen.assignedAt=util.now() end
  return chosen
end
